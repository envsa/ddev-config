[![tests](https://github.com/envsa/ddev-config/actions/workflows/tests.yml/badge.svg)](https://github.com/envsa/ddev-config/actions/workflows/tests.yml) ![project is maintained](https://img.shields.io/maintenance/yes/2025.svg)
